 ...
 */
#if defined(OPENSSL)
int MQTTProtocol_connect(const char* ip_address, const char *intfc_name, Clients* aClient, int ssl, int websocket, int MQTTVersion,
		MQTTProperties* connectProperties, MQTTProperties* willProperties)
#else
int MQTTProtocol_connect(const char* ip_address, const char *intfc_name, Clients* aClient, int websocket, int MQTTVersion,
		MQTTProperties* connectProperties, MQTTProperties* willProperties)
#endif
{
	int rc, port;
	...
	rc = Socket_new(ip_address, addr_len, intfc_name, port, &(aClient->net.socket));
