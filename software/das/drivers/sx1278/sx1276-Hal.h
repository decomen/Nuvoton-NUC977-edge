...
#define SX1276ReadDio0()  			SX_DID0_READ()
#define SX1276ReadDio1()      (0)
#define SX1276ReadDio2()      (0)
#define SX1276ReadDio3()  	  (0)
#define SX1276ReadDio4()		(0)
#define SX1276ReadDio5()		(0)
...
#define GET_TICK_COUNT( )                           ( rt_tick_get())
#define TICK_RATE_MS( ms )                          ( ms * (RT_TICK_PER_SECOND/1000))
